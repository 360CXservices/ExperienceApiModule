...
namespace VirtoCommerce.XDigitalCatalog.Queries
{
    public class SearchProductQueryHandler : IQueryHandler<SearchProductQuery, SearchProductResponse>, IQueryHandler<LoadProductsQuery, LoadProductResponse>
    {
        ...
        public virtual async Task<LoadProductResponse> Handle(LoadProductsQuery request, CancellationToken cancellationToken)
        {
            ...
            //{
            //    //item.variationProperties = new List<VariationProperty>();
            //   //item.variationProperties = new List<VariationProperty>();
            //   var variationIds = item.IndexedVariationIds;
            //    var req = request;
            //    req.ObjectIds = variationIds;
            //    var search = _mapper.Map<SearchProductQuery>(req);

            //    var res = await Handle(search, cancellationToken);

            //    var va = result.Results.FirstOrDefault().IndexedVariationIds
            //    var prod = res.Results;
            //    foreach (var pr in prod)
            //    {
            //        var catalogProduct = pr.IndexedProduct;
            //        //var colorProperty = catalogProduct.Properties.FirstOrDefault(x => x.Name == "");
            //        //fore
            //        //item.variationProperties.Add(new VariationProperty() { Name = })

            //        foreach (var prop in catalogProduct.Properties)
            //        {
            //            item.variationProperties.Add(new VariationProperty { Name = prop.Name, Property =  prop });
            //            //if (item.Properties != null && item.Properties.Any(x => x.Name == prop.Name))
            //            //{
            //            //    if (item.Properties.FirstOrDefault(x => x.Name == prop.Name).PropertyValues != null)
            //            //        item.Properties.FirstOrDefault(x => x.Name == prop.Name).PropertyValues.Add(prop);
            //            //    else
            //            //    {
            //            //        item.Properties.FirstOrDefault(x => x.Name == prop.Name).PropertyValues = new List<Property> { prop };
            //            //    }
            //            //}
            //            //else
            //            //{
            ...
            //            //    {
            //            //        item.Properties = new List<VariationProperty>()
            //            //        {
            //            //            new VariationProperty{ Name = prop.Name , PropertyValues = list }
            //            //        };
            //            //    }
            //            //    else
            //            //    {
            //            //        item.Properties.Add(new VariationProperty
            //            //        {
            //            //            Name = prop.Name,
            //            //            PropertyValues = list
            //            //        });
